...
\begin{align}
	...
	&= \int_{0}^{t} F_{p} \left( Be^{-m_1\tau} + (1-B)e^{-m_2\tau} \right) C_{a}(t-\tau)d\tau
\end{align}
...
\captionsetup[subfloat]{captionskip=0.5cm}
	\centering
	\subfloat[TK model fit; $K_{trans}$ = 0.64 min$^{-1}$ ]{\includegraphics [width=0.48\linewidth]{tk2}\label{fig:t1plot}}\hspace{0.03\linewidth}
	\subfloat[ETK model fit; $K_{trans}$ = 0.56 min$^{-1}$]{\includegraphics[width=0.48\linewidth]{etk2}\label{fig:t2plot}}\\ \vspace{0.5cm}	
	\subfloat[PR model fit; $K_{trans}$ = 0.22 min$^{-1}$]{\includegraphics [width=0.48\linewidth]{pr2}\label{fig:t1plot}}\hspace{0.03\linewidth}
	\subfloat[2CXM model fit; $K_{trans}$ = 1.0 min$^{-1}$]{\includegraphics[width=0.48\linewidth]{2cxm2}\label{fig:t2plot}}\\	
\vspace{0.5cm}
