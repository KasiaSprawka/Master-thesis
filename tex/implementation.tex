...
\captionsetup[subfloat]{captionskip=0.5cm}
	\centering
	\subfloat[TK model fit; $K_{trans}$ = ]{\includegraphics [width=0.48\linewidth]{tk1}\label{fig:t1plot}}\hspace{0.03\linewidth}
	\subfloat[ETK model fit; $K_{trans}$ = ]{\includegraphics[width=0.48\linewidth]{etk1}\label{fig:t2plot}}\\	
	\subfloat[PR model fit; $K_{trans}$ = ]{\includegraphics [width=0.48\linewidth]{tk1}\label{fig:t1plot}}\hspace{0.03\linewidth}
	\subfloat[2CXM model fit; $K_{trans}$ = ]{\includegraphics[width=0.48\linewidth]{etk1}\label{fig:t2plot}}\\	
\vspace{0.5cm}
