...
%\captionsetup[subfloat]{captionskip=0.5cm}
	\centering
	{\includegraphics[width = \textwidth]{clusters2}\label{fig:tcluster1}}
...
%\captionsetup[subfloat]{captionskip=0.5cm}
	\centering
	{\includegraphics[width = \textwidth]{temporal_points}\label{fig:temporal_points}}
...
In order to determine $S_0$, the time point before rapid signal drop, $T_{baseline}$ had to be found  as marked with red dot in Figure \ref{fig:temporal_points}.
%%% Experimenting with two methods, not decided yet %%%%

To achieve it, firstly, for every time course under analysis, its derivative was calculated. Further, because the   
