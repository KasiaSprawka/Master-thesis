...
%\captionsetup[subfigure]{labelformat=empty,textformat=simple}
	\centering
	\sidesubfloat[]{\includegraphics[width=0.43\linewidth]{baltman-egfr}} \\ \vspace{10pt}  
 	\sidesubfloat[]{\includegraphics[width=0.43\linewidth]{baltman-tk}} \hfill \sidesubfloat[]{\includegraphics[width=0.43\linewidth]{baltman-etk}} \\ \vspace{10pt}   
	\sidesubfloat[]{\includegraphics[width=0.43\linewidth]{baltman-pr}} \hfill \sidesubfloat[]{\includegraphics[width=0.43\linewidth]{baltman-2cxm}}
...
%\captionsetup[subfigure]{labelformat=empty,textformat=simple}
	\centering
	\sidesubfloat[]{\includegraphics[width=0.43\linewidth]{reg-egfr}} \\ \vspace{10pt}  
 	\sidesubfloat[]{\includegraphics[width=0.43\linewidth]{reg-tk}} \hfill \sidesubfloat[]{\includegraphics[width=0.43\linewidth]{reg-etk}} \\ \vspace{10pt}   
	\sidesubfloat[]{\includegraphics[width=0.43\linewidth]{reg-pr}} \hfill \sidesubfloat[]{\includegraphics[width=0.43\linewidth]{reg-2cxm}}
